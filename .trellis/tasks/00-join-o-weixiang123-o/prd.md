...
`o-weixiang123-o` just ran `trellis init` on a fresh clone, saw "Developer
...
- `.trellis/workspace/o-weixiang123-o/journal-*.md` — their session log,
...
- Check if `.trellis/workspace/o-weixiang123-o/` already exists — if yes, it's
  their journal from another machine and worth mentioning.
- Run `python ./.trellis/scripts/task.py list --assignee o-weixiang123-o` to
...
python ./.trellis/scripts/task.py archive 00-join-o-weixiang123-o
```
