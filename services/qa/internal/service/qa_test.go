...
func (r blockingAgentRunner) RunWithToolResultCallback(ctx context.Context, input []agent.Message, observer agent.Observer, _ func(string, string, string)) (agent.Result, error) {
...
func (r completedThenCancelledRunner) RunWithToolResultCallback(ctx context.Context, input []agent.Message, observer agent.Observer, _ func(string, string, string)) (agent.Result, error) {
	return r.RunWithObserver(ctx, input, observer)
}
...
func (r cancelAfterCompletedRunner) RunWithToolResultCallback(ctx context.Context, input []agent.Message, observer agent.Observer, _ func(string, string, string)) (agent.Result, error) {
	return r.RunWithObserver(ctx, input, observer)
}
...
func (r cancelBeforeCompletedObserverRunner) RunWithToolResultCallback(ctx context.Context, input []agent.Message, observer agent.Observer, _ func(string, string, string)) (agent.Result, error) {
	return r.RunWithObserver(ctx, input, observer)
}
...
func (toolProgressRunner) RunWithToolResultCallback(ctx context.Context, input []agent.Message, observer agent.Observer, _ func(string, string, string)) (agent.Result, error) {
...
func (r *fakeAgentRunner) RunWithToolResultCallback(ctx context.Context, input []agent.Message, observer agent.Observer, _ func(string, string, string)) (agent.Result, error) {
	return r.RunWithObserver(ctx, input, observer)
}
...
func (r errorAgentRunner) RunWithToolResultCallback(ctx context.Context, input []agent.Message, observer agent.Observer, _ func(string, string, string)) (agent.Result, error) {
	return r.RunWithObserver(ctx, input, observer)
}
...
func (maxIterationsAgentRunner) RunWithToolResultCallback(ctx context.Context, input []agent.Message, observer agent.Observer, _ func(string, string, string)) (agent.Result, error) {
