...
func (e *elasticsearchEngine) Search(ctx context.Context, req *types.SearchRequest) (*types.SearchResult, error) {
	...
	// Build bool query from condition
	boolQuery := buildBoolQueryFromCondition(req.Filter, req.KbIDs)
	...
	if matchText != nil {
		textQuery := buildQueryStringQuery(matchText, vectorSimilarityWeight)
		if boolQuery != nil {
...
func buildBoolQueryFromCondition(filter map[string]interface{}, kbIDs []string) map[string]interface{} {
...
func buildQueryStringQuery(matchText *types.MatchTextExpr, vectorSimilarityWeight float64) map[string]interface{} {
	if matchText == nil {
		return nil
	}
