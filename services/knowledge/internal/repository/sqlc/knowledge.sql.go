...
type CreateProcessingJobRow struct {
	ID                   string             `json:"id"`
	KnowledgeBaseID      string             `json:"knowledge_base_id"`
...
func (q *Queries) CreateProcessingJob(ctx context.Context, arg CreateProcessingJobParams) (CreateProcessingJobRow, error) {
