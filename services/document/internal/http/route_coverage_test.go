...
func TestActiveReportRoutesHaveStableScaffoldCoverage(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodGet, "/reports", "not_implemented"},
		{http.MethodPost, "/reports", "not_implemented"},
		{http.MethodGet, "/reports/rpt_123", "not_implemented"},
		{http.MethodPatch, "/reports/rpt_123", "not_implemented"},
		{http.MethodDelete, "/reports/rpt_123", "not_implemented"},
		{http.MethodGet, "/reports/rpt_123/outlines", "not_implemented"},
		{http.MethodPost, "/reports/rpt_123/outlines", "not_implemented"},
		{http.MethodGet, "/reports/rpt_123/outlines/out_123", "not_implemented"},
		{http.MethodPatch, "/reports/rpt_123/outlines/out_123", "not_implemented"},
		{http.MethodDelete, "/reports/rpt_123/outlines/out_123/sections/sec_123", "not_implemented"},
		{http.MethodGet, "/reports/rpt_123/sections", "not_implemented"},
		{http.MethodPost, "/reports/rpt_123/sections", "not_implemented"},
		{http.MethodGet, "/reports/rpt_123/sections/sec_123", "not_implemented"},
		{http.MethodPatch, "/reports/rpt_123/sections/sec_123", "not_implemented"},
		{http.MethodGet, "/reports/rpt_123/sections/sec_123/versions", "not_implemented"},
		{http.MethodPost, "/reports/rpt_123/sections/sec_123/versions", "not_implemented"},
